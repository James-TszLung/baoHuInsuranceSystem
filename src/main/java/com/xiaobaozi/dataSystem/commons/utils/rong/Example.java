...
import com.xiaobaozi.dataSystem.commons.utils.rong.models.ChatRoomInfo;
import com.xiaobaozi.dataSystem.commons.utils.rong.models.ChatroomQueryResult;
import com.xiaobaozi.dataSystem.commons.utils.rong.models.ChatroomUserQueryResult;
import com.xiaobaozi.dataSystem.commons.utils.rong.models.CheckOnlineResult;
import com.xiaobaozi.dataSystem.commons.utils.rong.models.CodeSuccessResult;
import com.xiaobaozi.dataSystem.commons.utils.rong.models.GroupInfo;
import com.xiaobaozi.dataSystem.commons.utils.rong.models.GroupUserQueryResult;
import com.xiaobaozi.dataSystem.commons.utils.rong.models.HistoryMessageResult;
import com.xiaobaozi.dataSystem.commons.utils.rong.models.ListBlockChatroomUserResult;
import com.xiaobaozi.dataSystem.commons.utils.rong.models.ListGagChatroomUserResult;
import com.xiaobaozi.dataSystem.commons.utils.rong.models.ListGagGroupUserResult;
import com.xiaobaozi.dataSystem.commons.utils.rong.models.ListWordfilterResult;
import com.xiaobaozi.dataSystem.commons.utils.rong.models.QueryBlacklistUserResult;
import com.xiaobaozi.dataSystem.commons.utils.rong.models.QueryBlockUserResult;
import com.xiaobaozi.dataSystem.commons.utils.rong.models.SMSImageCodeResult;
import com.xiaobaozi.dataSystem.commons.utils.rong.models.SMSSendCodeResult;
import com.xiaobaozi.dataSystem.commons.utils.rong.models.SMSVerifyCodeResult;
...
public class Example {
	...
	public static void main(String[] args) throws Exception {
		String appKey = "c9kqb3rdcm5zj";//替换成您的appkey
		String appSecret = "KO11f1CLhRmik";//替换成匹配上面key的secret
		...
		// 获取 Token 方法 
		TokenResult userGetTokenResult = rongCloud.user.getToken("2b7ab86e5f0e4b6ba0b531db2b2457d9", "廖棋广", "http://www.rongcloud.cn/images/logo.png");
		...
		CodeSuccessResult messagePublishPrivateResult = rongCloud.message.publishPrivate("af632590e1ef49b490ac7a18c73cc276", messagePublishPrivateToUserId, messagePublishPrivateVoiceMessage, "thisisapush", "{\"pushData\":\"hello\"}", "4", 0, 0, 0, 0);
		...
		TxtMessage messagePublishSystemTxtMessage = new TxtMessage("{\"stewardType\":\"2\",\"stewardId\":\"stewardIdDatail\",\"url\":\"http://urlName/stewardSystem/tgySteward/getTgyStewardPageDetial.htm\",\"content\":\"恭喜您于crateTime成为小包子品牌管家，您的账号为phone，请尽快完善信息以便开始接单设计\"}", "helloExtra");
		...
		//{"stewardType":"2","stewardId":"stewardIdDatail","url":"http://urlName/stewardSystem/tgySteward/getTgyStewardPageDetial.htm","content":"恭喜您于crateTime成为小包子品牌管家，您的账号为phone，请尽快完善信息以便开始接单设计"}
