...
//
//			if ("c".equals(name) || "v".equals(name)) {
//				vIsOpen = true;
...
//					if (this.formatString != null && !n.equals(""))
...
//	}
//	/*
//	 * public static void main(String[] args) throws Exception { XLSX2CSV
//	 * xlsx2csv = new XLSX2CSV("d:\\result3.xlsx", "d:\\outs.csv");
//	 * xlsx2csv.process(); }
//	 */
//
//}