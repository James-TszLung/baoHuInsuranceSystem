package com.xiaobaozi.dataSystem.commons.search;
...
public class SearchCriteria<T> implements Serializable {
	...
	public String toString() {
		return "SearchCriteria [pageCount=" + totalPageCount + ", pageNo=" + pageNo + ", pageSize=" + pageSize + ", startIdx="
				+ startIdx + ", totalCount=" + totalCount + ", orderBy=" + orderBy + "]";
	}
