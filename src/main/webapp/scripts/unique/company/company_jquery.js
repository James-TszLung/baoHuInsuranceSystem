...
var lastPostData;
function doSearch(f) {
	var searchURL = "/configuration/serachCompany.htm";
	if (f) {
...
// 切换到添加菜单页面
function addView() {
	visitUrl(ctxPath + "/configuration/goAddCompanyView.htm", 1, 1, 1);
}
function reply(id) {
	visitUrl(ctxPath + "/configuration/goEditCompanyView.htm?id=" + id, 1, 1, 1);
}
