...
<script type="text/javascript"
        src="${pageContext.request.contextPath}/scripts/unique/pushEssay/pushEssay_jquery.js"></script>
...
<div id="tgySteward_search_from" class="query_condition_body">
    ...
    <table width="98%" border="0" cellspacing="0" cellpadding="0">
        <tr>
            <td width="20%"><label>文章标题：</label><input placeholder="输入文章标题" name="title" type="text" class="condition"/>
            </td>
            <td width="20%"><label>内容简介：</label><input placeholder="输入内容简介" name="introduction" type="text"
                                                       class="condition"/></td>
            ...
            <td width="15%"><label>导航类别：</label>
                <select name="classification" class="validatebox-text">
                    <option value="">全部</option>
            ...
            <td width="20%" align="center"><input name="" type="submit" class="airlines_button" value="搜索"
