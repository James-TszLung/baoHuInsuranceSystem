...
<script type="text/javascript" src="${pageContext.request.contextPath}/scripts/unique/consultation/consultation_jquery.js"></script>
...
<div id="tgySteward_search_from" class="query_condition_body">
	...
	<table width="98%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="20%"><label>联系电话：</label><input placeholder="输入反馈内容" name="phone" type="text" class="condition" /></td>
