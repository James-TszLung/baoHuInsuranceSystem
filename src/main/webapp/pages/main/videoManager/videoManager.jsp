...
<script type="text/javascript" src="${pageContext.request.contextPath}/scripts/unique/videoManager/videoManager_jquery.js"></script>
...
<div id="tgySteward_search_from" class="query_condition_body">
	...
	<table width="98%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="20%"><label>视频名称：</label><input placeholder="输入视频名称" name="name" type="text" class="condition" /></td>
