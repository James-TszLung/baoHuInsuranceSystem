...
<script type="text/javascript" src="${pageContext.request.contextPath}/scripts/unique/KnowledgeBase/KnowledgeBase_jquery.js"></script>
...
<div id="tgySteward_search_from" class="query_condition_body">
	...
	<table width="98%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="20%"><label>模块名称：</label><input placeholder="输入模块名称" name="name" type="text" class="condition" /></td>
