			...
			<div class="policy_added">
				<ul>
					<li>
						<label>*知识模块名称：</label>
						<span class="sel_span">
							<input placeholder="请输入知识模块名称" type="text" name="name" id="name" />
						</span>
					</li>
						<li>
						<label>*知识模块描述:</label>
						<span class="sel_span">
							<textarea placeholder="请输入内容简介" name="describe" id="describe" 
...
<script type="text/javascript" src="${pageContext.request.contextPath}/scripts/unique/KnowledgeBase/AddKnowledgeBase_jquery.js"></script>
