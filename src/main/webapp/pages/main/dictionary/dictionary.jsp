...
<script type="text/javascript" src="${pageContext.request.contextPath}/scripts/unique/dictionary/dictionary_jquery.js"></script>
...
<div id="tgySteward_search_from" class="query_condition_body">
	...
	<table width="98%" border="0" cellspacing="0" cellpadding="0">
		<tr>
			<td width="20%"><label>字段名称：</label><input placeholder="输入字段名称" name="name" type="text" class="condition" /></td>
