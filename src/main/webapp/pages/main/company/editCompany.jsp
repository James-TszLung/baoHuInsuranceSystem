			...
			<div class="policy_added">
				<ul>
					<li>
						<label>*公司名称：</label>
						<span class="sel_span">
							<input placeholder="请输入公司名称" type="text" name="companyName" id="companyName"  value="${sc.companyName}" />
						</span>
					</li>
					<li>
						<label>*客服电话：</label>
						<span class="sel_span">
							<input placeholder="请输入客服电话" type="text" name="phone" id="phone"  value="${sc.phone}"/>
						</span>
					</li>
					...
					<li>
						<label>*搜索标签：</label>
						<span class="sel_span">
							<input placeholder="请输入搜索标签" type="text" name="searchKey" id="searchKey"  value="${sc.searchKey}"/>
						</span>
					</li>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/scripts/unique/company/editCompany_jquery.js"></script>
